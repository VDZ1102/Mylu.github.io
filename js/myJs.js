const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Thảo My năm mới mãi đỉnh mãi chất sớm thành hot tiktoker và ít trốn kèo hơn :)) 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/Mylu.jpg",    //ảnh pop up đầu
      imageWidth: 320,
      imageHeight: 400,
